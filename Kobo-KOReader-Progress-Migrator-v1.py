...
def run_unified(sqlite_path, books_folder, koreader_folder, dev_books, dry_run, existing_only,
                clear_cache, test_book_title, log_fn, done_fn, appimage_win, sandbox_workdir, manual_mode=False):
    ...
    def _run(self):
        ...
        def worker():
            run_unified(sqlite, books, koreader, dev_bks, dry, existing, cache, test_title,
                        self._log, self._on_done, appimage_win, sandbox_workdir, manual_mode=manual)
